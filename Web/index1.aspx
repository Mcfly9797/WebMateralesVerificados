<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="index1.aspx.cs" Inherits="Web.index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="datos">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="background-color: black; color:gray; font-family:Verdana; width:100%">
